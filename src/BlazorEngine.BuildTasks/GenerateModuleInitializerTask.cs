...
namespace BlazorEngine.BuildTasks
{
  ...
  /// embedded metadata with BlazorEngine's MetadataRegistry — zero configuration required.
  /// </summary>
  public class GenerateModuleInitializerTask : Task
  {
    ...
    public override bool Execute()
    {
      try
      {
        ...
        bool hasMetadata = File.Exists(MetadataFilePath) && new FileInfo(MetadataFilePath).Length > 0;
