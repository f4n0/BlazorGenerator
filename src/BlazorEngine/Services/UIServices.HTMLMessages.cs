...
public partial class UIServices
{
  ...
  /// <param name="title">The title to display on the dialog.</param>
  public void ShowConfirmation(object receiver, Func<DialogResult, Task> callback, string message,
    string primaryText = "Yes", string secondaryText = "No", string? title = null)
  {
    ShowMessageBox(new DialogParameters<MessageBoxContent>
    {
      Content = new MessageBoxContent
...
#pragma warning disable CS0618 // Type or member is obsolete
    DialogService.ShowDialog(typeof(MessageBox), parameters.Content, dialogParameters);
